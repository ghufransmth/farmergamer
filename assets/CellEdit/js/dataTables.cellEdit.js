...
jQuery.fn.dataTable.Api.register('MakeCellsEditable()', function (settings) {
    ...
    if (table != null) {
        ...
        $(table.body()).on('click', 'td', function () {
            // table.draw();
            // alert("asdasd");
            $(".my-cancel-class").remove();
            $(".my-input-class").remove();
            $(".my-confirm-class").remove();
...
function getInputHtml(currentColumnIndex, settings, oldValue) {
    ...
    switch (inputType) {
        ...
        case "list-confirm": // List w/ confirm
            ...
            input.html = input.html + "</select>&nbsp;<a href='#' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this);'>Simpan</a> <a href='#' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>Batal</a> ";
            input.focus = false;
            break;
        ...
        case "datepicker-confirm":
	        ...
	        input.html = "<input id='ejbeatycelledit' type='text' name='date' class='datepick " + inputCss + "'   value='" + oldValue + "'></input> &nbsp;<a href='#' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>Simpan</a> <a href='#' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>Batal</a>";
        ...
        case "text-confirm": // text input w/ confirm
            input.html = "<input id='ejbeatycelledit' class='" + inputCss + "' value='"+oldValue+"'></input>&nbsp;<a href='#' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>Simpan</a> <a href='#' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>Batal</a> ";
            break;
