...
<section class="tambahDicari" id="tambahDicari">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <ol class="breadcrumb" style="background-color: transparent;border: 0;padding: 0;">
                    ...
                    <li class="active"><a href="javascript:void(0)" onclick="t_dicari();" style="color: #db4a39;font-weight: bold;">Tambah Dicari</a></li>
                </ol>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="kd_dicari" id="kd_dicari" value="<?php echo $kd_awal;?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="jenis_dicari" id="jenis_dicari" style="background: #fff;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama_dicari" id="nama_dicari" class="form-control" style="background: #fff;" placeholder="Masukkan Nama Produk / Jasa Dijual">
                                        </div>
                                    </div>
...
<script>
    ...
    function insertData(){
        ...
        {
        $.ajax({
            url: '<?php echo base_url();?>toko_saya/katalog_saya/insert_dicari',
            data: form_data,
            method: 'POST',
            dataType: 'json',
