...
<section class="editDicari" id="editDicari">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label">Kd. Dicari</label>
                                            <input type="text" class="form-control" name="kd_dicari" id="kd_dicari" value="<?php echo $dicari['kd_dicari'];?>" readonly>
                                            <input type="hidden" id="id_dicari" value="<?php echo $dicari['id_dicari'];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $dicari['username'];?>" style="text-transform: uppercase;" readonly>
                                            <input type="hidden" name="id_user" id="id_user" value="<?php echo $dicari['id_user'];?>">
                                        </div>
                                    </div>

                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label">Jenis Dicari</label>
                                            ...
                                            <input type="text" class="form-control" readonly value="<?php echo ucwords($dicari['jenis_dicari']);?>">
                                            <input type="hidden" name="jenis_dicari" id="jenis_dicari" class="form-control" value="<?php echo $dicari['jenis_dicari'];?>">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            rows="2" cols="30" maxlength="100"><?php echo $dicari['judul'];?></textarea>
                                            <div id="chars1" style="text-align: right;"><?php echo strlen($dicari['judul']);?> / 100 Karakter</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="id_game" id="id_game" style="background: #fff;">
                                                <option value="<?php echo $dicari['id_game'];?>"><?php echo $dicari['nama_game'];?></option>
                                                <?php 
                                                    $cari_lainnya = $this->db->select("*")->from("list_game")->where_not_in('id_game', $dicari['id_game'])->get();
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama_dicari" id="nama_dicari" class="form-control" style="background: #fff;" placeholder="Masukkan Nama Produk / Jasa Dijual" value="<?php echo $dicari['nama_dicari'];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="jml" id="jml" class="form-control" style="background: #fff;" value="<?php echo $dicari['jumlah'];?>" onkeypress="validasi_jml()">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" style="background: #fff;" name="ket" id="ket" placeholder="Masukkan Keterangan Tambahan Mengenai Produk / Jasa"
                                            rows="4" cols="30" maxlength="250"><?php echo $dicari['keterangan'];?></textarea>
                                            <div id="chars2" style="text-align: right;"><?php echo strlen($dicari['keterangan']);?> / 250 Karakter</div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="hrg_satuan" id="hrg_satuan" class="form-control" style="background: #fff;" onkeypress="total_1();validasi_hsatuan();" value="<?php echo $dicari['harga'];?>">
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    function halaman_ini(){
        location.href = '<?php echo base_url();?>toko_saya/katalog_saya/edit_dicari/<?php echo $this->uri->segment(4);?>/<?php echo $this->uri->segment(5);?>';
    }
    ...
    // function kd_jual(){
        ...
        $(function(){
            $("#jenis_dicari").change(function(){
            // $("#jenis_jual").on("ready change",function(){
            var valkd=$("#jenis_dicari").val();
            
            $.ajax({
                url:"<?php echo site_url('toko_saya/katalog_saya/cari_kddicari');?>",
                type:"POST",
                data:"value_kd="+valkd, //data: "name="+nama variable
                cache:false,
                success:function(html){ //event success
                    var val_hsl = $("#kd_dicari").val(html); //selector dengan nama mirip seperti ...
                    console.log(val_hsl);
    ...
    function insertData(){
        ...
        form_data.append('id_dicari',$("#id_dicari").val());
        form_data.append('kd_dicari',$("#kd_dicari").val());
        form_data.append('id_user',$("#id_user").val());
        form_data.append('jenis_dicari',$("#jenis_dicari").val());
        form_data.append('jdl',$("#jdl").val());
        form_data.append('id_game',$("#id_game").val());
        form_data.append('nama_dicari',$("#nama_dicari").val());
        ...
        {
        $.ajax({
            url: '<?php echo base_url();?>toko_saya/katalog_saya/proses_edit_dicari',
            data: form_data,
            method: 'POST',
            dataType: 'json',
    ...
    $(document).on("ready", function() {
        ...
        $("#gambar").fileinput({
            ...
            initialPreview: [
                ...
                '<?php echo base_url();?>assets/custom/images/image_dicari/<?php echo $pic1;?>',
            ...
            initialPreviewConfig: [ //setinggan lebih lanjut initial preview
                <?php $num=1;foreach($ambil_gambar AS $pic2):?>
                {
                    ...
                    url: "<?php echo base_url();?>toko_saya/katalog_saya/hapus_gambar2/<?php echo $pic2;?>/<?php echo $dicari['id_dicari'];?>",
                    // size: <?php //echo $fsize;?>,
                    size : "<?php echo filesize('./assets/custom/images/image_dicari/'.$pic2);?>", // fungsi php filesize untuk cari ukuran dari file
                    key : "<?php echo $num;?>"
                },
                <?php $num++;endforeach;?>
